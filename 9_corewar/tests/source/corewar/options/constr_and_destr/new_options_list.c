...
/*   Updated: 2020/01/17 19:37:48 by wmaykit          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_options_list	*new_options_list(char *i_options_name, int *m_index_arg,
																char **i_argv)
{
	void			*funcs_new_opt;
	t_options_list	*o_new;
	...
	if (((func_new_opt_obj*)funcs_new_opt)[o_new->id])
	{
		o_new->option_obj =
			((func_new_opt_obj*)funcs_new_opt)[o_new->id](m_index_arg, i_argv);
		if (errno)
		{
